 ...
 *   The core class is {@link repackage.org.apache.commons.math3.analysis.differentiation.DerivativeStructure
 ...
 *   repackage.org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiableFunction
 *   UnivariateDifferentiableFunction} interface. Any differentiable function should implement this
 *   interface.
 * </p>
 * <p>
 *   The {@link repackage.org.apache.commons.math3.analysis.differentiation.UnivariateFunctionDifferentiator
 *   UnivariateFunctionDifferentiator} interface defines a way to differentiate a simple {@link
 *   repackage.org.apache.commons.math3.analysis.UnivariateFunction UnivariateFunction} and get a {@link
 *   repackage.org.apache.commons.math3.analysis.differentiation.UnivariateDifferentiableFunction
